import { g as hn } from "./sanity-DDM0-WJH.js";
function An(U, X) {
...
function Lt() {
  ...
  (p ||
    ...
    ge ||
      (ge = function (o, l) {
        for (
          var r = arguments.length, c = new Array(r > 2 ? r - 2 : 0), O = 2;
          O < r;
          O++
        )
          c[O - 2] = arguments[O];
    ...
    he ||
      (he = function (o) {
        for (
          var l = arguments.length, r = new Array(l > 1 ? l - 1 : 0), c = 1;
          c < l;
          c++
        )
          r[c - 1] = arguments[c];
  ...
  function et() {
    let s =
      arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Xt();
    const o = (i) => et(i);
    if (
      ((o.version = "3.3.1"),
      (o.removed = []),
      ...
      ze = function () {
        ...
        if (!(Y && Y === e)) {
          if (
            ...
            (e = L(e)),
            (ie =
              dn.indexOf(e.PARSER_MEDIA_TYPE) === -1
                ? Tn
                : e.PARSER_MEDIA_TYPE),
            (d = ie === "application/xhtml+xml" ? Ae : ae),
            (T = D(e, "ALLOWED_TAGS") ? a({}, e.ALLOWED_TAGS, d) : it),
            (_ = D(e, "ALLOWED_ATTR") ? a({}, e.ALLOWED_ATTR, d) : rt),
            (He = D(e, "ALLOWED_NAMESPACES")
              ? a({}, e.ALLOWED_NAMESPACES, Ae)
              : mn),
            (Ue = D(e, "ADD_URI_SAFE_ATTR")
              ? a(L(pt), e.ADD_URI_SAFE_ATTR, d)
              : pt),
            (ut = D(e, "ADD_DATA_URI_TAGS")
              ? a(L(mt), e.ADD_DATA_URI_TAGS, d)
              : mt),
            ...
            e.ADD_TAGS &&
              (typeof e.ADD_TAGS == "function"
                ...
                : (T === it && (T = L(T)), a(T, e.ADD_TAGS, d))),
            e.ADD_ATTR &&
              (typeof e.ADD_ATTR == "function"
                ? (H.attributeCheck = e.ADD_ATTR)
                : (_ === rt && (_ = L(_)), a(_, e.ADD_ATTR, d))),
            e.ADD_URI_SAFE_ATTR && a(Ue, e.ADD_URI_SAFE_ATTR, d),
            e.FORBID_CONTENTS &&
              (N === ke && (N = L(N)), a(N, e.FORBID_CONTENTS, d)),
            e.ADD_FORBID_CONTENTS &&
              (N === ke && (N = L(N)), a(N, e.ADD_FORBID_CONTENTS, d)),
            ve && (T["#text"] = !0),
            ...
            (S === void 0 && (S = Vt(le, c)),
              S !== null && typeof te == "string" && (te = S.createHTML("")));
          (p && p(e), (Y = e));
        }
      },
      Tt = a({}, [...Re, ...Oe, ...kt]),
            ...
            : e.namespaceURI === pe
              ? t.namespaceURI === C
                ...
                : t.namespaceURI === de
                  ...
                  : !!_t[n]
              : e.namespaceURI === C
                ? (t.namespaceURI === de && !_e[f]) ||
                  (t.namespaceURI === pe && !Te[f])
                  ? !1
                  : !_t[n] && (pn[n] || !Tt[n])
    ...
    const At = function (e) {
        ...
        if (
          ...
          return (I(e), !0);
        if (
          !(H.tagCheck instanceof Function && H.tagCheck(n)) &&
          (!T[n] || ne[n])
        ) {
          if (
            !ne[n] &&
        ...
        return (e instanceof tt && !En(e)) ||
          ...
          : (z &&
              ...
              e.textContent !== t &&
                (q(o.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
            M(R.afterSanitizeElements, e, null),
            !1);
      },
      St = function (e, t, n) {
        if (ct && (t === "id" || t === "name") && (n in l || n in _n))
          return !1;
        if (!(we && !Me[t] && h(sn, t))) {
          if (!(at && h(ln, t))) {
            if (
              !(H.attributeCheck instanceof Function && H.attributeCheck(t, e))
            ) {
              if (!_[t] || Me[t]) {
                if (
                  !(
      ...
      gn = function i(e) {
        ...
        for (M(R.beforeSanitizeShadowDOM, e, null); (t = n.nextNode()); )
          (M(R.uponSanitizeShadowNode, t, null),
            At(t),
            Ot(t),
    ...
    return (
      (o.sanitize = function (i) {
        ...
        if (
          (xe || ze(e), (o.removed = []), typeof i == "string" && (oe = !1), oe)
        ) {
          if (i.nodeName) {
        ...
        const m = gt(oe ? i : t);
        for (; (f = m.nextNode()); )
          (At(f), Ot(f), f.content instanceof O && gn(f.content));
        if (oe) return i;
        if (G) {
          if (ue)
            for (g = on.call(t.ownerDocument); t.firstChild; )
              g.appendChild(t.firstChild);
          else g = t;
          return (
            (_.shadowroot || _.shadowrootmode) && (g = an.call(r, g, !0)),
            g
          );
        }
...
function Sn() {
  return (
    Nt ||
      ((Nt = 1),
      (Ye = window.DOMPurify || (window.DOMPurify = Lt().default || Lt()))),
    Ye
  );
}
var It = Sn();
