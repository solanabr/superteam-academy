...
import { html as bt, htmlCompletionSource as wt } from "./index-BKhmWDdr.js";
import "./sanity-DDM0-WJH.js";
import "./index-By0zYFtB.js";
import "./index-CKzs9ZvX.js";
class U {
...
const He = {
  [u.Blockquote](t, e, r) {
    return r.next != 62
      ? !1
      : (r.markers.push(
          k(u.QuoteMark, e.lineStart + r.pos, e.lineStart + r.pos + 1),
        ),
...
function x(t, e, r) {
  let n = t.length - 1;
  n >= 0 && t[n].to == e && t[n].type == u.CodeText
    ? (t[n].to = r)
    : t.push(k(u.CodeText, e, r));
}
const $ = {
  ...
  FencedCode(t, e) {
    ...
    for (
      ...
      if (e.indent - e.baseIndent < 4)
        for (; d < e.text.length && e.text.charCodeAt(d) == s; ) d++;
    ...
    return (
      t.addNode(
        t.buffer.writeElements(l, -n).finish(u.FencedCode, t.prevLineEnd() - n),
        n,
      ),
      !0
    );
  ...
  BulletList(t, e) {
    let r = ie(e, t, !1);
    if (r < 0) return !1;
    t.block.type != u.BulletList &&
      t.startContext(u.BulletList, e.basePos, e.next);
    let n = ce(e, e.pos + 1);
    return (
  ...
  ATXHeading(t, e) {
    ...
    let a = t.buffer
      ...
      .writeElements(
        t.parser.parseInline(e.text.slice(n + r + 1, o), s + r + 1),
        -s,
      );
...
` +
  ...
  finish(e, r) {
    return (this.stage == 2 || this.stage == 3) &&
      O(r.content, this.pos) == r.content.length
  ...
  complete(e, r, n) {
    return (
      e.addLeafElement(
        r,
        k(u.LinkReference, this.start, this.start + n, this.elts),
      ),
      !0
    );
  }
  ...
  advance(e) {
    for (;;) {
      ...
      if (this.stage == 0) {
        ...
        (this.elts.push(
          k(u.LinkMark, this.pos + this.start, this.pos + this.start + 1),
        ),
          this.pos++);
  ...
  nextLine(e, r, n) {
    ...
    return (
      ...
      e.addLeafElement(
        n,
        k(
          i == 61 ? u.SetextHeading1 : u.SetextHeading2,
          n.start,
          e.prevLineEnd(),
          [...e.parser.parseInline(n.content, n.start), o],
        ),
      ),
      !0
    );
    ...
    ((this.parser = e),
      ...
      (this.lineStart =
        ...
        this.absoluteLineEnd =
          s[0].from),
      (this.block = U.create(u.Document, 0, this.lineStart, 0, 0)),
...
` + e.scrub();
  ...
  reuseFragment(e) {
    ...
    return r
      ? ((this.absoluteLineStart += r),
        (this.lineStart = Ve(this.absoluteLineStart, this.ranges)),
        this.moveRangeI(),
  ...
  readLine() {
    ...
    for (
      this.absoluteLineEnd = n, e.reset(r);
      e.depth < this.stack.length;
      e.depth++
    ) {
...
`);
  ...
  addLeafElement(e, r) {
    this.addNode(
      this.buffer
        .writeElements(re(r.children, e.marks), -r.from)
  ...
  finishLeaf(e) {
    ...
    this.addNode(
      this.buffer
        ...
        .finish(u.Paragraph, e.content.length),
      e.start,
    );
  }
  elt(e, r, n, s) {
    return typeof e == "string"
      ? k(this.parser.getNodeType(e), r, n, s)
      : new je(e, r);
  }
  get buffer() {
...
function Fe(t, e, r, n, s) {
  ...
  return (
    h(r.to + n, !1),
    new H(r.type, o, a, r.to + n - l, r.tree ? r.tree.propValues : void 0)
  );
}
class Z extends st {
    ...
    if (R(r.defineNodes)) {
      ...
      for (let L of r.defineNodes) {
        ...
        (d.push(Q.define({ id: b, name: g, props: E && [[v.group, E]] })),
          S &&
            (c || (c = {}),
            Array.isArray(S) || S instanceof it
              ? (c[g] = S)
              : Object.assign(c, S)));
      }
    ...
    props:
      t >= u.Escape
        ...
        : [
            [
              v.group,
              t in He ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
            ],
          ],
    top: e == "Document",
  });
...
const Ue = { resolve: "Emphasis", mark: "EmphasisMark" },
  _e = { resolve: "Emphasis", mark: "EmphasisMark" },
  M = {},
  _ = {};
class C {
  constructor(e, r, n, s) {
  ...
  LinkEnd(t, e, r) {
    ...
    for (let n = t.parts.length - 1; n >= 0; n--) {
      ...
      if (s instanceof C && (s.type == M || s.type == _)) {
        if (
          !s.side ||
          (t.skipSpace(s.to) == r && !/[(\[]/.test(t.slice(r + 1, r + 2)))
        )
...
function Mt(t, e, r, n, s) {
  ...
  if (
    ...
    (h &&
      ((l = t.skipSpace(h.to)),
      l != h.to &&
        ((f = Qe(i, l - t.offset, t.offset)), f && (l = t.skipSpace(f.to)))),
      t.char(l) == 41 &&
...
class ae {
  ...
  get hasOpenLink() {
    for (let e = this.parts.length - 1; e >= 0; e--) {
      let r = this.parts[e];
      if (r instanceof C && (r.type == M || r.type == _)) return !0;
    }
    return !1;
  }
  addElement(e) {
  ...
  resolveMarkers(e) {
    for (let n = e; n < this.parts.length; n++) {
      ...
      for (let g = l + 1; g < n; g++)
        (this.parts[g] instanceof D && f.push(this.parts[g]),
          (this.parts[g] = null));
      s.type.mark && f.push(this.elt(s.type.mark, s.from, d));
      let c = this.elt(h, p, d, f);
      ((this.parts[l] =
        i && a.from != p ? new C(a.type, a.from, p, a.side) : null),
...
function re(t, e) {
  ...
  for (let s of e) {
    ...
    if (n < r.length && r[n].from < s.from) {
      let i = r[n];
      i instanceof D &&
        (r[n] = new D(i.type, i.from, i.to, re(i.children, [s])));
    } else r.splice(n++, 0, s);
  }
  return r;
}
  ...
  takeNodes(e) {
    ...
    for (;;) {
      ...
      if (r.to - n <= e.ranges[e.rangeI].to) e.addNode(r.tree, f);
        ...
        let p = new H(
          e.parser.nodeSet.types[u.Paragraph],
          [],
          [],
          0,
          e.block.hashProp,
  ...
  return {
    wrap: ot((s, i) => {
      ...
      if (e && (o == u.CodeBlock || o == u.FencedCode)) {
        ...
        r &&
        (o == u.HTMLBlock || o == u.HTMLTag || o == u.CommentBlock)
      )
    ...
    f = () => {
      n.push(
        t.elt(
          ...
          s + a,
          s + l,
          t.parser.parseInline(e.slice(a, l), s + a),
        ),
      );
    };
            ...
            s[3]
              ...
              : ((i = Ae(t.text, n + s[0].length)),
                i > -1 &&
                  ...
                  ((Se.lastIndex = i),
                  (s = Se.exec(t.text)),
                  s && (i = s.index + s[0].length)));
          return i < 0
            ? -1
            : (t.addElement(t.elt("URL", r, i + t.offset)), i + t.offset);
        },
      },
    ],
  },
...
const _t = {
    ...
    parseInline: [
      { name: "Superscript", parse: Ke(94, "Superscript", "SuperscriptMark") },
    ],
  },
  qt = {
    defineNodes: [
    ...
    parseInline: [
      { name: "Subscript", parse: Ke(126, "Subscript", "SubscriptMark") },
    ],
  },
  Qt = {
  ...
  Je = dt({ commentTokens: { block: { open: "<!--", close: "-->" } } }),
  Ye = new v(),
  We = Nt.configure({
    props: [
      Me.add((t) =>
  ...
  return (r) => {
    if (r && t) {
      ...
      if (
        ...
        typeof t == "function"
          ? (n = t(r))
          : (n = ue.matchLanguageName(t, r, !0)),
        n instanceof ue)
      )
        return n.support
          ? n.support.language.parser
          : Lt.getSkippingParser(n.load());
...
class K {
  ...
  blank(e, r = !0) {
    ...
    if (e != null) {
      ...
      for (
        let s = this.to - this.from - n.length - this.spaceAfter.length;
        s > 0;
        s--
      )
        n += " ";
  ...
  marker(e, r) {
    let n =
      this.node.name == "OrderedList" ? String(+tt(this.item, e)[2] + r) : "";
  ...
  for (let s = r.length - 1; s >= 0; s--) {
    ...
    if (i.name == "Blockquote" && (o = /^ *>( ?)/.exec(a.text.slice(l))))
      ...
      (o[3] && (p += o[3].replace(/[xX]/, " ")),
        n.push(new K(i.parent, l, l + f, o[1], h, p, i)));
    }
  }
  return n;
}
    ...
    ({ state: e, dispatch: r }) => {
      let n = X(e),
        ...
        o = e.changeByRange((a) => {
          if (
            !a.empty ||
            (!q.isActiveAt(e, a.from, -1) && !q.isActiveAt(e, a.from, 1))
          )
            return (i = { range: a });
          let l = a.from,
            h = s.lineAt(l),
          ...
          if (p.to - p.spaceAfter.length > l - h.from)
            return (i = { range: a });
          let d =
            l >= p.to - p.spaceAfter.length && !/\S/.test(h.text.slice(p.to));
          if (p.item && d) {
            ...
            for (let w = 0, S = f.length - 1; w <= S; w++)
              g +=
                w == S && !L
                  ? f[w].marker(s, 1)
                  : f[w].blank(
                      w < S ? z(h.text, 4, f[w + 1].from) - g.length : null,
                    );
          let B = l;
      ...
      return i
        ? !1
        : (r(e.update(o, { scrollIntoView: !0, userEvent: "input" })), !0);
    },
  er = Wt();
function xe(t) {
...
function Be(t, e, r) {
  ...
  for (let s = 0, i = t.length - 2; s <= i; s++)
    n += t[s].blank(
      s < i ? z(r.text, 4, t[s + 1].from) - n.length : null,
      s < i,
    );
  return he(n, e);
}
...
const nr = ({ state: t, dispatch: e }) => {
        ...
        if (i.empty && q.isActiveAt(t, i.from)) {
          ...
          if (h.length) {
            ...
            if (
              ...
              (!f.item ||
                l.from <= f.item.from ||
                !/\S/.test(l.text.slice(0, f.to)))
            ) {
              let d = l.from + f.from;
              if (
                f.item &&
                f.node.from < f.item.from &&
                /\S/.test(l.text.slice(f.from, f.to))
              ) {
    ...
    return n
      ? !1
      : (e(t.update(s, { scrollIntoView: !0, userEvent: "delete" })), !0);
  },
  sr = [
    { key: "Enter", run: er },
...
function cr(t = {}) {
  ...
  let l = t.extensions ? [t.extensions] : [],
    ...
    f;
  (o && h.push(lr),
    r instanceof fe ? (h.push(r.support), (f = r.language)) : r && (f = r));
  let p = e || f ? Yt(e, f) : void 0;
  (l.push(Rt({ codeParser: p, htmlParser: a.language.parser })),
...
function or() {
  if (Y) return Y;
  let t = wt(new pt(ct.create({ extensions: rt }), 0, !0));
...
const ar =
  ...
  lr = kt.domEventHandlers({
    paste: (t, e) => {
      ...
      if (n.empty) return !1;
      let s =
        (r = t.clipboardData) === null || r === void 0
          ? void 0
          : r.getData("text/plain");
      if (
        !s ||
        !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(s) ||
        (/^www\./.test(s) && (s = "https://" + s),
        !q.isActiveAt(e.state, n.from, 1))
      )
        return !1;
      let i = X(e.state),
        o = !1;
