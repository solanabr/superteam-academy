  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground">{t("arcade.subtitle")}</p>
      </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-3">
        {GAMES.map((game) => (
          <Link key={game.id} href={game.href} className="group outline-none">
            <Card className="border-border/50 hover:border-primary/50 h-full bg-black/20 transition-all duration-300 hover:bg-black/40">
              <CardContent className="flex h-full flex-col p-5">
                ...
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {game.badge && (
                      <span
                        className={`text-[10px] font-bold uppercase tracking-wider ${game.badge.color}`}
                      >
                        {game.badge.text}
                      </span>
                    )}
                ...
                {/* Divider */}
                <div className="bg-border/50 my-4 h-[1px] w-full" />
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center gap-1 font-medium text-primary">
                    <Zap className="fill-primary/20 h-3.5 w-3.5" />+{game.xp} XP
                  </div>
                </div>
              </CardContent>
            </Card>
