...
// Render smoke only — the SP3-B PublishPinClient carries its own tests and
// fetches on mount, so it is stubbed out here.
...
describe("AdminPublishPage (smoke)", () => {
  it("renders the i18n'd screen title and the publish pin card", async () => {
