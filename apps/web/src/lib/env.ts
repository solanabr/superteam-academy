...
const publicEnvSchema = z.object({
  ...
  // Optional Dynamic environment id. Public, origin-bound client identifier
  // from the Dynamic dashboard — it ships in the client bundle by design, and
  // the dashboard's allowed-origins list is what actually scopes it.
  //
  // Optional on purpose, like the analytics keys:
