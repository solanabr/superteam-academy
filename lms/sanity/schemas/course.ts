...
export const course = defineType({
  ...
  fields: [
    ...
    defineField({ name: "totalCompletions", title: "Total Completions", type: "number", initialValue: 0 }),
    defineField({ name: "totalEnrollments", title: "Total Enrollments", type: "number", initialValue: 0 }),
    defineField({
      name: "modules",
      title: "Modules",
      type: "array",
