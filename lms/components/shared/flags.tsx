  ...
  return (
    <svg className={className} viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
      <g fillRule="evenodd">
        ...
        <path fill="#fff" d="m30.4 11 3.4 10.3h10.6l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.3 3.3-10.2-8.6-6.3h10.7zm60.8 0 3.3 10.3h10.6l-8.6 6.3 3.3 10.3-8.6-6.4-8.7 6.3 3.3-10.2-8.5-6.3H88zm60.8 0 3.3 10.3H166l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.3 3.3-10.2-8.6-6.3h10.7zm60.8 0 3.3 10.3h10.7l-8.7 6.3 3.3 10.3-8.6-6.4-8.7 6.3 3.4-10.2-8.7-6.3h10.6zm60.8 0 3.3 10.3h10.6l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.3 3.3-10.2-8.6-6.3h10.7zM60.8 37l3.3 10.2H74.7l-8.6 6.3 3.2 10.3-8.6-6.4-8.6 6.4 3.3-10.3-8.6-6.3h10.6zm60.8 0 3.3 10.2h10.6l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.4 3.3-10.3-8.6-6.3h10.6zm60.8 0 3.3 10.2h10.6l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.4 3.3-10.3-8.6-6.3H179zm60.8 0 3.4 10.2h10.6l-8.7 6.3 3.3 10.3-8.6-6.4-8.7 6.4 3.3-10.3-8.5-6.3h10.5zm60.8 0 3.3 10.2h10.6l-8.6 6.3 3.3 10.3-8.7-6.4-8.6 6.4 3.3-10.3-8.6-6.3h10.6z" />
      </g>
    </svg>
  );
}
  ...
  return (
    <svg className={className} viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
      <g strokeWidth="1pt">
        ...
        <path fill="#ffffef" d="M195.3 225.7a112 112 0 0 0-3 14.3c57.6-8.8 117.5 3.2 172.2 34.6a112 112 0 0 0 8.2-12.1c-55.6-30.8-116.7-43.2-177.4-36.8z" />
      </g>
    </svg>
  );
}
...
export function FlagIN({ className = "h-4 w-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="320" cy="240" r="46" fill="none" stroke="#008" strokeWidth="5" />
