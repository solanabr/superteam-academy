    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-24 text-center">
        ...
        <p className="mt-2 text-muted-foreground">
          Solve at least {PRACTICE_MILESTONES[0]} challenges to earn your first Practice Arena certificate.
        </p>
          ...
          >
            ...
            <div className="p-8 sm:p-12">
              ...
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground/70">Practice Arena Credential</p>
                  </div>
                </div>
              ...
              <div className="text-center mb-10">
                ...
                <h1 className="text-2xl font-bold sm:text-3xl tracking-tight">Practice Arena</h1>
                <p className="mt-1.5 text-base font-semibold" style={{ color }}>{level} Credential</p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 text-center mb-8">
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Solved</p>
                </div>
                <div className="space-y-1">
                  <p className="text-3xl font-black text-xp-gold">{practiceXP.toLocaleString()}</p>
                  <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Practice XP</p>
                </div>
                <div className="space-y-1">
              ...
              {categoriesMastered.length > 0 && (
                <>
                  ...
                  <div className="text-center">
                    <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider mb-3">Categories Mastered</p>
