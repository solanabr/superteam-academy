    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5"><BookOpen className="h-4 w-4" />{course.lessonCount} lessons</span>
          <span className="flex items-center gap-1.5"><Code className="h-4 w-4" />{course.challengeCount} challenges</span>
          <span className="flex items-center gap-1.5 text-xp-gold"><Zap className="h-4 w-4" />{course.xpTotal} XP</span>
          <span className="flex items-center gap-1.5"><Users className="h-4 w-4" />{course.totalEnrollments.toLocaleString()} enrolled</span>
          <span className="flex items-center gap-1.5"><Trophy className="h-4 w-4" />{course.totalCompletions.toLocaleString()} completed</span>
        </div>
      </div>
        ...
        <Card className="mb-8">
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-medium">{completedLessons}/{course.lessonCount} lessons</span>
            </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          {lesson.type === "challenge" && (
                            <Badge variant="outline" className="ml-auto text-[10px]">Challenge</Badge>
                          )}
