              ...
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground/70">{t("onChainCredential")}</p>
                  </div>
                </div>
        ...
        <CardContent className="p-6">
          ...
          {certificates && certificates.length > 0 && (
            <>
              ...
              <h3 className="text-sm font-semibold mb-2">{t("courseCertificates")}</h3>
                ...
                {certificates.map((cert) => (
                  <div key={cert.txHash || cert.courseId} className="flex items-center justify-between text-sm rounded-md border px-3 py-2">
                    ...
                    {cert.txHash ? (
                      ...
                      <span className="text-[11px] text-muted-foreground/60">{t("awaitingTx")}</span>
                    )}
                  </div>
                ))}
              </div>
