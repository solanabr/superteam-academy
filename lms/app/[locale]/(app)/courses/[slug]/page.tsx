      ...
      <div className="mb-8">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5">
            ...
            {course.lessonCount} {tc("lessons", { count: course.lessonCount })}
          </span>
          <span className="flex items-center gap-1.5">
            <Code className="h-4 w-4" />
            {course.challengeCount} {t("challengeCount")}
          </span>
          ...
          <span className="flex items-center gap-1.5">
            ...
            {course.totalCompletions.toLocaleString()} {tc("completed")}
          </span>
        </div>
      </div>
                ...
                <AccordionTrigger className="text-left">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      ...
                      {tc("lessons", { count: module.lessons.length })}
                    </p>
                  </div>
                </AccordionTrigger>
                <AccordionContent>
                  <div className="space-y-1">
                    {module.lessons.map((lesson) => {
                      ...
                      const completed =
                        progress?.lessonsCompleted.includes(currentIndex);
                      const txHash =
                        progress?.lessonTxHashes?.[String(currentIndex)];
                      return (
                        <div
                          key={lesson.id}
          ...
          <Card className="sticky top-24">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-xp-gold">
                  {course.xpTotal} XP
                </span>
              </div>
              <Separator />
              ...
              {!isEnrolled ? (
                ...
                <div className="space-y-2 mt-4">
                  <Badge className="w-full justify-center py-2 bg-solana-green text-white dark:text-black">
                    {tc("completed")}
                  </Badge>
      ...
      <Dialog open={enrollDialogOpen} onOpenChange={setEnrollDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>{t("nameOnCertificates")}</DialogDescription>
          </DialogHeader>
          <Input
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                setDisplayNameMutation.isPending || enrollMutation.isPending
              }
            >
