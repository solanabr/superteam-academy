...
// ── Rust ──
const RUST_KW =
  "fn|let|mut|pub|use|struct|enum|impl|trait|mod|const|static|type|where|for|in|if|else|match|return|self|super|crate|as|ref|move|async|await|unsafe|extern|dyn|true|false";
const RUST_TY =
  "Self|Option|Result|Vec|String|Box|Rc|Arc|HashMap|HashSet|Pubkey|Account|Signer|Program|Context|Clock|bool|u8|u16|u32|u64|u128|i8|i16|i32|i64|i128|f32|f64|usize|isize";
...
const TS_KW =
  "import|export|from|const|let|var|function|async|await|return|if|else|for|of|in|while|do|class|interface|type|extends|implements|new|throw|try|catch|finally|switch|case|default|break|continue|typeof|instanceof|as|is|true|false|this|super|yield|delete|void";
const TS_TY =
  "Promise|Array|Map|Set|Record|Partial|Readonly|Required|Pick|Omit|Exclude|Extract|string|number|boolean|null|undefined|never|any|unknown|object|bigint|symbol|Uint8Array|Buffer|PublicKey|Keypair|Connection|Transaction|SystemProgram|Signer|AccountInfo|TransactionInstruction|LAMPORTS_PER_SOL";
