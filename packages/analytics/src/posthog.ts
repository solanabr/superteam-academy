// PostHog Integration for Heatmaps & Session Recording
import { z } from "zod";
...
/**
 * Generate the PostHog script snippet for <head> injection.
 * Uses the lightweight snippet approach (no npm dependency required).
 */
