				...
				<div className="text-center space-y-4">
					<div className="relative mx-auto w-48 h-32 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg border-2 border-dashed border-primary/30 flex items-center justify-center">
						<div className="text-center space-y-2">
							...
							<div className="text-xs text-muted-foreground">{t("certificate.preview")}</div>
						</div>
					</div>

					<div>
						<h3 className="font-semibold text-lg">{certificate.title}</h3>
						<p className="text-muted-foreground">{t("certificate.issuedBy", { issuer: certificate.issuer })}</p>
					</div>
				...
				<div className="space-y-3">
					<div className="text-sm space-y-2">
						<div className="flex items-center justify-between">
							<span className="text-muted-foreground">{t("certificate.certificateType")}</span>
						...
						<div className="flex items-center justify-between">
							<span className="text-muted-foreground">{t("certificate.blockchain")}</span>
							<span className="font-medium">Solana</span>
						</div>
						{certificate.verifiable && (
							<div className="flex items-center justify-between">
								<span className="text-muted-foreground">{t("certificate.verification")}</span>
								<span className="font-medium text-green-600">{t("certificate.onChain")}</span>
							</div>
						)}
					</div>
						...
						<div className="p-3 bg-muted/50 rounded-lg">
							<div className="flex items-start gap-3">
								...
								<div className="text-sm">
									<div className="font-medium">{t("certificate.verifiableCredential")}</div>
