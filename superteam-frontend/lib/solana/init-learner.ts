...
const INIT_LEARNER_DISCRIMINATOR = Buffer.from([137, 243, 85, 146, 80, 49, 210, 152])
...
export function createInitLearnerTransaction(walletAddress: string): Transaction {
