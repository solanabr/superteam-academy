...
export function Navbar() {
  ...
  // Show stable skeleton while client-side auth is still resolving
  const settling = !mounted || (connected && isLoading);
        ...
        <div className="hidden items-center gap-3 md:flex min-h-[2.5rem]">
          ...
          {settling ? (
            <div className="flex items-center gap-3 animate-pulse">
              <div className="h-8 w-14 rounded-lg bg-secondary" />
