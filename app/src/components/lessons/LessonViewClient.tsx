  ...
  return (
    <div className="bg-[#0A0A0B] text-[#EDEDEF] font-body overflow-hidden h-screen flex flex-col relative selection:bg-solana/20 selection:text-solana">
      ...
      <main className="relative z-10 flex flex-1 overflow-hidden">
        {/* LEFT PANE: Lesson Content (40%) */}
        <section className="flex flex-col w-full lg:w-2/5 border-r border-white/10 bg-[#0A0A0B]/50 overflow-hidden relative group/lesson">
          {/* Content Scroll Area */}
        ...
        <section className="hidden lg:flex flex-col flex-1 bg-[#050506] relative">
          ...
          <div className="h-48 border-t border-white/10 bg-[#020202] flex flex-col shrink-0">
            ...
            <div className="flex-1 p-4 font-mono text-sm overflow-auto custom-scrollbar text-text-secondary">
              {playgroundOutput ? (
                <pre className="whitespace-pre-wrap">{playgroundOutput}</pre>
              ) : (
                <>
                  <div className="mb-1">
                    <span className="text-green-500">➜</span> <span className="text-blue-400">~/superteam-academy</span> <span className="text-white">cargo build-bpf</span>
                  </div>
                  <div className="opacity-70 mb-1">Compiling solana-twitter v0.1.0...</div>
                  <div className="opacity-70">Finished release [optimized] target(s) in 0.45s</div>
                </>
              )}
            </div>
          </div>
