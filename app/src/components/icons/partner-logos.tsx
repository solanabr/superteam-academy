...
export function SolanaLogo({ size = 32, ...props }: LogoProps) {
  return (
    ...
    >
      ...
      <path d="M9 20.5L12.3 17H23L19.7 20.5H9Z" fill="url(#sol-g1)" />
      <path d="M9 11.5L12.3 15H23L19.7 11.5H9Z" fill="url(#sol-g2)" />
      <path d="M9 16L12.3 12.5H23L19.7 16H9Z" fill="url(#sol-g3)" />
      <defs>
        <linearGradient
          id="sol-g1"
          x1="9"
...
export const PARTNER_LOGO_MAP: Record<
  string,
