...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    quote:
      "I tried three other Solana courses and gave up. This one clicked immediately. The account model explanation is the clearest I've seen anywhere.",
    stars: 5,
  },
  {
    initials: "EO",
    ...
    quote:
      "Token-2022 course saved me hours of reading docs. Went straight to the important extensions with working code examples.",
    stars: 5,
  },
  {
    initials: "SV",
    ...
    quote:
      "The challenge format is addictive. You actually write and run code in every lesson, not just watch someone else. Night and day difference.",
    stars: 5,
  },
  {
    initials: "DK",
    ...
    role: "Rust Developer",
    quote:
      "As a Rust dev moving into Solana, Anchor was the missing piece. This course bridges that gap perfectly. Production-grade from day one.",
    stars: 5,
  },
  {
    initials: "AM",
    ...
    quote:
      "Earned my first on-chain credential in 48 hours. The soulbound NFT on my wallet feels like a real achievement, not just a PDF certificate.",
    stars: 5,
  },
  {
    initials: "JP",
    ...
    quote:
      "Built and deployed a real swap program after finishing the AMM course. The x·y=k math finally made sense after those challenges.",
    stars: 5,
  },
  {
    initials: "HZ",
    ...
    quote:
      "The missing owner check vulnerability lesson alone could've saved me from a critical bug. Every Solana dev needs to take this security course.",
    stars: 5,
  },
];
