import type { SkillDataPoint } from "@/components/profile/skill-chart";
    ...
    achievements: [
      {
        ...
        xpReward: 50,
        claimed: true,
        claimedAt: "2025-12-01T00:00:00Z",
      },
      {
        id: "fast-learner",
        name: "Fast Learner",
        ...
        xpReward: 100,
        claimed: true,
        claimedAt: "2025-12-10T00:00:00Z",
      },
      {
        id: "course-master",
        name: "Course Master",
        ...
        xpReward: 200,
        claimed: true,
        claimedAt: "2026-01-10T00:00:00Z",
      },
      {
        id: "streak-starter",
        name: "Streak Starter",
        ...
        xpReward: 75,
        claimed: true,
        claimedAt: "2025-12-20T00:00:00Z",
      },
      {
        id: "code-warrior",
        name: "Code Warrior",
      ...
      },
      {
        ...
        xpReward: 150,
        claimed: true,
        claimedAt: "2025-11-15T00:00:00Z",
      },
    ],
    skillData: [
    ...
    achievements: [
      {
        ...
        xpReward: 50,
        claimed: true,
        claimedAt: "2025-12-05T00:00:00Z",
      },
      {
        id: "course-master",
        name: "Course Master",
        ...
        xpReward: 200,
        claimed: true,
        claimedAt: "2025-12-15T00:00:00Z",
      },
      {
        id: "security-expert",
