...
export const TRACKS: Record<number, { name: string; display: string; color: string; icon: string }> = {
  0: { name: "standalone", display: "Standalone", color: "#a1a1aa", icon: "BookOpen" },
  1: { name: "anchor", display: "Anchor Framework", color: "#4a8c5c", icon: "Anchor" },
  2: { name: "rust", display: "Rust for Solana", color: "#d4755e", icon: "Code" },
  3: { name: "defi", display: "DeFi Development", color: "#2d9b6e", icon: "TrendingUp" },
  4: { name: "security", display: "Program Security", color: "#ef4444", icon: "Shield" },
  5: { name: "frontend", display: "Frontend & dApps", color: "#43b5a0", icon: "Layout" },
  6: { name: "token", display: "Token Engineering", color: "#d4b83d", icon: "Coins" },
};
