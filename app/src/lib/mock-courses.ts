...
export const MOCK_COURSES: SanityCourse[] = [
  {
    ...
    description:
      "Master the core concepts of Solana: accounts, programs, transactions, and the runtime model. Learn how accounts store state, how programs process instructions, and why Solana is the fastest blockchain for developers.",
...
- Familiarity with command line tools`,
    ...
    instructor: {
      _id: "i1",
      name: "Lucas Oliveira",
      bio: "Solana core contributor & educator with 4 years building on-chain.",
      twitterHandle: "lucasoldev",
    },
    ...
    modules: [
      {
        ...
        order: 1,
        description:
          "Understand what makes Solana unique and set up your development environment.",
        lessons: [
          {
            _id: "l1",
      ...
      },
      {
        ...
        order: 2,
        description:
          "Everything on Solana is an account. Learn what that means and how to work with it.",
        lessons: [
          {
            _id: "l4",
      ...
      },
      {
        ...
        order: 3,
        description:
          "Learn how transactions bundle instructions and how to send them on-chain.",
        lessons: [
          {
            _id: "l7",
          ...
          {
            _id: "l9",
            title: "Challenge: Build a Transfer Script",
            type: "challenge",
            order: 3,
            xpReward: 100,
            estimatedMinutes: 25,
  ...
  },
  {
    ...
    slug: "anchor-basics",
    description:
      "Build production-grade Solana programs with Anchor. Learn PDAs, CPIs, account validation, and error handling. Go from zero to deploying your first program on Devnet.",
...
- Basic Rust knowledge`,
    ...
    instructor: {
      _id: "i2",
      name: "Ana Lima",
      bio: "Anchor maintainer & DeFi protocol engineer. Built 3 production programs on mainnet.",
      twitterHandle: "anaanchor",
    },
    ...
    modules: [
      ...
      },
      {
        ...
        order: 2,
        description:
          "Master Program Derived Addresses — the backbone of Solana state design.",
        lessons: [
          {
            _id: "l13",
          ...
          {
            _id: "l14",
            title: "Bump Seeds & Canonical Bumps",
            type: "content",
            order: 2,
            xpReward: 75,
            estimatedMinutes: 18,
          ...
          {
            _id: "l15",
            title: "Challenge: Counter with PDA",
            type: "challenge",
            order: 3,
            xpReward: 150,
            estimatedMinutes: 45,
      ...
      {
        _id: "m6",
        title: "CPIs & Composability",
        order: 3,
        description:
          "Call other programs from your program and build composable on-chain logic.",
        lessons: [
          {
            _id: "l16",
          ...
          {
            _id: "l18",
            title: "Challenge: Build a Token Vault",
            type: "challenge",
            order: 3,
            xpReward: 200,
            estimatedMinutes: 60,
  ...
  },
  {
    ...
    slug: "token-2022",
    description:
      "Deep dive into Token-2022 — the next-generation SPL token standard. Master transfer hooks, confidential transfers, metadata pointers, non-transferable mints, and interest-bearing tokens.",
...
- Understanding of SPL tokens`,
    ...
    instructor: {
      _id: "i3",
      name: "Pedro Carvalho",
      bio: "Token program specialist. Contributed to Token-2022 extensions spec at Solana Labs.",
      twitterHandle: "pedrotokens",
    },
    tags: ["token-2022", "extensions", "spl", "soulbound"],
    modules: [
      {
        _id: "m7",
        title: "Token-2022 Architecture",
        order: 1,
        description:
          "Understand how Token-2022 extends SPL Token with a flexible extension system.",
        lessons: [
          {
            _id: "l19",
          ...
          {
            _id: "l20",
            title: "Extension System Deep Dive",
            type: "content",
            order: 2,
            xpReward: 75,
            estimatedMinutes: 20,
          ...
          {
            _id: "l21",
            title: "Challenge: Non-Transferable Token",
            type: "challenge",
            order: 3,
            xpReward: 150,
            estimatedMinutes: 35,
      ...
      },
      {
        ...
        order: 2,
        description:
          "Build transfer hooks, attach metadata, and mint the soulbound XP token.",
        lessons: [
          {
            _id: "l22",
  ...
  },
  {
    ...
    slug: "defi-amm",
    description:
      "Build a constant-product AMM from scratch. Understand liquidity pools, swap math, slippage, price impact, and flash loans. Learn how Raydium and Orca work under the hood.",
...
- Basic understanding of DeFi concepts`,
    ...
    instructor: {
      _id: "i4",
      name: "Rafael Souza",
      bio: "DeFi protocol engineer & MEV researcher. Previously at Orca and Meteora.",
      twitterHandle: "rafadefi",
    },
    ...
    modules: [
      {
        ...
        order: 1,
        description:
          "Learn the math behind automated market makers and liquidity pools.",
        lessons: [
          {
            _id: "l25",
          ...
          {
            _id: "l26",
            title: "Liquidity Providers & LP Tokens",
            type: "content",
            order: 2,
            xpReward: 75,
            estimatedMinutes: 20,
      ...
      {
        _id: "m10",
        title: "Building the AMM Program",
        order: 2,
        description:
          "Implement initialize, add liquidity, and swap instructions in Anchor.",
        lessons: [
          {
            _id: "l28",
            title: "Pool Account Design",
            type: "content",
            order: 1,
            xpReward: 100,
            estimatedMinutes: 25,
          ...
          {
            _id: "l29",
            title: "Challenge: Initialize & Add Liquidity",
            type: "challenge",
            order: 2,
            xpReward: 250,
            estimatedMinutes: 60,
          ...
          {
            _id: "l30",
            title: "Challenge: Swap Instruction",
            type: "challenge",
            order: 3,
            xpReward: 300,
            estimatedMinutes: 90,
      ...
      },
      {
        ...
        order: 3,
        description:
          "Protect against attacks and optimize compute units for production.",
        lessons: [
          {
            _id: "l31",
            title: "Slippage Protection & Price Oracles",
            type: "content",
            order: 1,
            xpReward: 100,
            estimatedMinutes: 20,
          ...
          {
            _id: "l32",
            title: "Reentrancy & Flash Loan Attacks",
            type: "content",
            order: 2,
            xpReward: 100,
            estimatedMinutes: 20,
          ...
          {
            _id: "l33",
            title: "Challenge: CU Optimization",
            type: "challenge",
            order: 3,
            xpReward: 200,
            estimatedMinutes: 40,
  ...
  },
  {
    ...
    description:
      "Learn to audit and secure Solana programs. Study real exploit patterns: missing signer checks, account confusion, integer overflows, PDA collisions, and reentrancy. Build an immune program.",
...
- Understanding of PDAs and CPIs`,
    ...
    instructor: {
      ...
      bio: "Security researcher at Superteam & lead auditor. Found 12 critical bugs in production programs.",
      twitterHandle: "gabsec",
    },
    ...
    modules: [
      {
        ...
        order: 1,
        description:
          "Survey the most common Solana vulnerability classes and how they arise.",
        lessons: [
          {
            _id: "l34",
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            _id: "l38",
            title: "Account Confusion & Type Confusion",
            type: "content",
            order: 2,
            xpReward: 100,
            estimatedMinutes: 20,
          ...
          {
            _id: "l39",
            title: "Challenge: PDA Substitution — Fix It",
            type: "challenge",
            order: 3,
            xpReward: 250,
            estimatedMinutes: 50,
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            _id: "l42",
            title: "Challenge: Audit & Secure the Vault",
            type: "challenge",
            order: 3,
            xpReward: 300,
            estimatedMinutes: 60,
