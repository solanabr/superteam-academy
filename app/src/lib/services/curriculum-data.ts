            ...
            challenge: {
              ...
              testCases: [
                ...
                },
                {
                  ...
                  expectCodeContains: "console.log",
                  expectNoError: true,
                },
              ],
              language: "typescript",
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Uses anchor.workspace for program access",
                  expectCodeContains: "anchor.workspace",
                  expectNoError: true,
                },
                {
                  name: "Calls program.methods with .rpc()",
                  expectCodeContains: ".methods",
                  expectNoError: true,
                },
                {
                  name: "Uses expect assertions with .to.equal",
                  expectCodeContains: "expect",
                  expectNoError: true,
                },
              ],
              language: "typescript",
              ...
              testCases: [
                {
                  ...
                  expectCodeContains: "solana config",
                  expectNoError: true,
                },
                {
                  name: "Builds and deploys the program",
                  expectCodeContains: "anchor deploy",
                  expectNoError: true,
                },
                {
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Uses useWallet hook",
                  expectCodeContains: "useWallet",
                  expectNoError: true,
                },
                {
                  name: "Displays truncated address with toBase58",
                  expectCodeContains: "toBase58",
                  expectNoError: true,
                },
                {
                  name: "Fetches balance with getBalance",
                  expectCodeContains: "getBalance",
                  expectNoError: true,
                },
              ],
              language: "typescript",
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Validates recipient as PublicKey",
                  expectCodeContains: "new PublicKey",
                  expectNoError: true,
                },
                {
                  name: "Uses SystemProgram.transfer and sendTransaction",
                  expectCodeContains: "SystemProgram.transfer",
                  expectNoError: true,
                },
                {
                  name: "Confirms transaction",
                  expectCodeContains: "confirmTransaction",
                  expectNoError: true,
                },
              ],
              language: "typescript",
        ...
        lessons: [
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Fetches parsed token accounts",
                  expectCodeContains: "getParsedTokenAccountsByOwner",
                  expectNoError: true,
                },
                {
                  name: "Uses TOKEN_PROGRAM_ID filter",
                  expectCodeContains: "TOKEN_PROGRAM_ID",
                  expectNoError: true,
                },
                {
                  name: "Parses tokenAmount and decimals",
                  expectCodeContains: "tokenAmount",
                  expectNoError: true,
                },
              ],
              language: "typescript",
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Calls getAssetsByOwner DAS method",
                  expectCodeContains: "getAssetsByOwner",
                  expectNoError: true,
                },
                {
                  name: "Parses content and metadata from response",
                  expectCodeContains: "content",
                  expectNoError: true,
                },
                {
                  name: "Uses useEffect with publicKey dependency",
                  expectCodeContains: "useEffect",
                  expectNoError: true,
                },
              ],
              language: "typescript",
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Calls Jupiter Ultra API endpoint",
                  expectCodeContains: "jup.ag",
                  expectNoError: true,
                },
                {
                  name: "Parses inAmount and outAmount",
                  expectCodeContains: "outAmount",
                  expectNoError: true,
                },
                {
                  name: "Sends signedTransaction with requestId",
                  expectCodeContains: "signedTransaction",
                  expectNoError: true,
                },
              ],
              language: "typescript",
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Uses transact and authorize for wallet connection",
                  expectCodeContains: "transact",
                  expectNoError: true,
                },
                {
                  name: "Persists auth_token in AsyncStorage",
                  expectCodeContains: "AsyncStorage",
                  expectNoError: true,
                },
                {
                  name: "Supports deauthorize for disconnect",
                  expectCodeContains: "deauthorize",
                  expectNoError: true,
                },
                {
                  name: "Displays address with toBase58",
                  expectCodeContains: "toBase58",
                  expectNoError: true,
                },
              ],
        ...
        lessons: [
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                {
                  name: "Calls Jupiter Ultra API for quote",
                  expectCodeContains: "jup.ag",
                  expectNoError: true,
                },
                {
                  name: "Signs transaction via MWA transact",
                  expectCodeContains: "signTransactions",
                  expectNoError: true,
                },
                {
                  name: "Handles VersionedTransaction",
                  expectCodeContains: "VersionedTransaction",
                  expectNoError: true,
                },
              ],
              language: "typescript",
          ...
          },
          {
            ...
            challenge: {
              ...
              testCases: [
                ...
                {
                  name: "Auto-refreshes with setInterval",
                  expectCodeContains: "setInterval",
                  expectNoError: true,
                },
                {
                  name: "Uses FlatList for token rendering",
                  expectCodeContains: "FlatList",
                  expectNoError: true,
                },
                {
                  name: "Supports pull-to-refresh with RefreshControl",
                  expectCodeContains: "RefreshControl",
                  expectNoError: true,
                },
              ],
              language: "typescript",
...
export const achievements: Achievement[] = [
  ...
  },
  {
    id: "rust-rookie",
    name: "Rust Rookie",
    description: "Complete a Rust track course",
    icon: "code",
    xpReward: 100,
    category: "skills",
  },
  {
    id: "anchor-expert",
    name: "Anchor Expert",
    description: "Complete Anchor Development course",
    icon: "anchor",
    xpReward: 150,
    category: "skills",
  },
  {
    ...
    description: "Complete Rust, Frontend, and DeFi tracks",
    icon: "layers",
    xpReward: 500,
    category: "skills",
  },
