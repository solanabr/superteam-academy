  ...
  if (!connected) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
        <User className="h-12 w-12 text-violet-500" />
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div className="text-center sm:text-left">
              <h1 className="text-3xl font-bold">{shortWallet}</h1>
              ...
              <p className="mt-3 flex items-center gap-1 text-xs text-muted-foreground justify-center sm:justify-start">
                <Calendar className="h-3 w-3" />
                {t("profile.memberSince", { date: "2026" })}
              </p>
            </div>
          </div>
        </div>
