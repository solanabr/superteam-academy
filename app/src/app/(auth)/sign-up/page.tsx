    ...
    <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border border-white/10 bg-zinc-900/70">
      ...
      <div className="relative grid min-h-[600px] md:grid-cols-[1fr_460px]">
        <section className="hidden p-10 md:block">
          <p className="inline-flex rounded-full border border-[#9945FF]/35 bg-[#9945FF]/15 px-3 py-1 text-xs text-[#d3b0ff]">
            Builder onboarding
          </p>
          <h1 className="mt-4 text-4xl font-semibold text-zinc-100">Create your Superteam Academy account</h1>
        ...
        <section className="p-6 sm:p-8">
          <Card className="border-white/10 bg-zinc-950/70">
            ...
            <CardContent className="space-y-4">
              ...
              <Input type="password" placeholder="Confirm password" className="bg-zinc-950/60" />

              <label className="flex items-center gap-2 text-sm text-zinc-400">
                <input type="checkbox" className="size-4 rounded border-white/20 bg-zinc-900" />
                I agree to the terms and privacy policy.
              </label>

              <Button className="w-full border border-white/10 bg-zinc-900 text-zinc-100">{t("submitSignUp")}</Button>
              ...
              <p className="text-sm text-zinc-400">
                ...
                <Link href="/sign-in" className="text-[#14F195] hover:underline">
                  Sign in
                </Link>
              </p>
            </CardContent>
