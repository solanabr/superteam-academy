    ...
    <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border border-border bg-card">
      ...
      <div className="relative grid min-h-[560px] md:grid-cols-[1fr_460px]">
        <section className="hidden p-10 md:block">
          <p className="inline-flex rounded-full border border-highlight/30 bg-highlight/10 px-3 py-1 text-xs text-highlight">
            Solana-native access
          </p>
          <h1 className="mt-4 text-4xl font-semibold text-foreground">
            Welcome back to Superteam Academy
          </h1>
          <p className="mt-3 max-w-md text-muted-foreground">
            Continue your learning streak, complete challenge lessons, and mint your next credential.
          </p>
          <div className="mt-8 space-y-3">
            <Feature text="Sign in with your Solana wallet — no password needed" />
            <Feature text="Your progress is anchored on-chain as soulbound XP" />
            <Feature text="Earn verifiable credentials as Metaplex Core NFTs" />
          </div>
        </section>
