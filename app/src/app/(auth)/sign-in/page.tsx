    ...
    <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border border-border bg-card">
      ...
      <div className="relative grid min-h-[560px] md:grid-cols-[1fr_460px]">
        <section className="hidden p-10 md:block">
          <p className="inline-flex rounded-full border border-[#ffd23f]/30 bg-[#ffd23f]/10 px-3 py-1 text-xs text-[#ffd23f]">
            Solana-native access
          </p>
          <h1 className="mt-4 text-4xl font-semibold text-foreground">Welcome back to Superteam Academy</h1>
        ...
        <section className="p-6 sm:p-8">
          <Card className="border-border bg-st-dark/70">
            <CardHeader>
              <CardTitle className="text-foreground">{t("welcomeBack")}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <Button className="w-full border border-border bg-card text-foreground">{t("submitSignIn")}</Button>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                <Link href="/sign-up" className="text-[#ffd23f] hover:underline">
                  Create an account
                </Link>
              </p>
            </CardContent>
