    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center">
        <div className="w-full max-w-md text-center">
          <div className="w-16 h-16 mx-auto mb-6 bg-neutral-900 rounded-full flex items-center justify-center">
            <svg
          ...
          <h1 className="text-3xl font-semibold tracking-tighter mb-3">
            Check your email
          </h1>
          <p className="text-neutral-500 text-base font-medium mb-8">
          ...
          <Link
            href="/auth/sign-in"
            className="px-8 py-3.5 bg-neutral-900 text-white rounded-full text-sm font-bold hover:bg-neutral-700 transition-all duration-300 inline-block"
          >
            Back to Sign In
          </Link>
        </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-neutral-500 text-base font-medium">
            Create an account to learn Solana development
          </p>
        </div>

        {/* OAuth Buttons */}
        <div className="space-y-3 mb-8">
          <WalletSignInButton mode="signup" />
