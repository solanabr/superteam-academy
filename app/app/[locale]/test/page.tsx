	...
	return (
		<div className="min-h-screen bg-bg-base p-10 lg:p-20">
			<h1 className="font-display text-4xl mb-10">
				COMPONENT FLIGHT CHECK: PROGRESS BAR
			</h1>

			<div className="grid grid-cols-1 md:grid-cols-2 gap-16">
				{/* Static Tests */}
				<div className="space-y-12">
					<h2 className="text-xl font-mono text-ink-secondary/50 uppercase tracking-widest border-b border-ink-secondary/20 pb-4">
						Static States
					</h2>
